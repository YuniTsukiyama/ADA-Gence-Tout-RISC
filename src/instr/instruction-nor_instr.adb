...
package body Instruction.Nor_Instr is
   ...
   begin
      ...
      Cpu_Instance.Registers (Self.Destination.Reg) :=
         Misc.Int16 ((Unsigned_16'Last xor (Left or Right))
                      and 2#0000000011111111#);
   end Execute;

end Instruction.Nor_Instr;
